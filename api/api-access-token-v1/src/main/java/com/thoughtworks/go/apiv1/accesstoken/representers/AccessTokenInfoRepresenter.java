...
public class AccessTokenInfoRepresenter {
    public static AccessTokenInfo fromJSON(JsonReader reader, Clock clock) {
        return new AccessTokenInfo(reader.getString("name"),
